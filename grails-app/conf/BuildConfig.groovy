...
grails.project.dependency.resolution = {
    ...
    dependencies {
        ...
        // below are for resolving gwt issues
...
//grails needs this and can't resolve it with ivy, be sure to match the other spring jar versions
        runtime 'org.springframework:spring-expression:4.1.9.RELEASE'
//grails needs this and can't resolve it with ivy, be sure to match the other spring jar versions
        compile 'org.codehaus.groovy:groovy-all:2.4.5'
//required because of this issue https://github.com/grails/grails-core/issues/10011#issuecomment-245138488
    ...
    plugins {
        ...
        // all gwt needed
        compile(':gwt:0.9.1')
        runtime ':resources:1.2.14'//don't use the default one download from gwt
